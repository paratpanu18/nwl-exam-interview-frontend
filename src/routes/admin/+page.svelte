...
<body class="flex flex-col w-[100vw] h-[100vh]">
    ...
    <div class="m-[2rem] w-full flex items-center">
    ...
    <!-- <div class="flex justify-start w-[100vw] h-[100vh] flex-wrap gap-x-16 m-[2rem]">
        <a href="/admin/seniors">
            <div class="card hover:bg-base-300 bg-base-200 border border-white w-[25vw] h-[25vh] flex justify-center items-center">
                <h1 class="text-2xl">Add / Remove Senior</h1>
            </div>
        </a>
        <a href="/">
            <div class="card hover:bg-base-300 bg-base-200 border border-white w-[25vw] h-[25vh] flex justify-center items-center">
                <h1 class="text-2xl">Add / Remove Junior</h1>
            </div>
        </a>
        <a href="/">
            <div class="card hover:bg-base-300 bg-base-200 border border-white w-[25vw] h-[25vh] flex justify-center items-center">
                <h1 class="text-2xl">Add / Remove Criteria Type</h1>
            </div>
        </a>
        <a href="/">
            <div class="card hover:bg-base-300 bg-base-200 border border-white w-[25vw] h-[25vh] flex justify-center items-center">
                <h1 class="text-2xl">View Score</h1>
            </div>
        </a>
    </div> -->
</body>
